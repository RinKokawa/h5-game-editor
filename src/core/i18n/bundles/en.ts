...
const en: Bundle = {
  ...
  'menu.tools.select': 'Select Tool',
  'menu.tools.pan': 'Pan Tool',
  'menu.tools.brush': 'Brush Tool',
  'menu.tools.eraser': 'Eraser Tool',
  'menu.tools.rect': 'Rect Tool',
  'menu.tools.entity': 'Entity Tool',
  'menu.tools.collider': 'Collider Tool',
  'menu.view.zoomIn': 'Zoom In',
  'menu.view.zoomOut': 'Zoom Out',
  'menu.view.actualSize': 'Actual Size',
  'menu.view.resetView': 'Reset View',
  'menu.view.toggleFullScreen': 'Toggle Full Screen',
  'menu.view.toggleConsole': 'Toggle Console',
  'menu.view.toggleLeftPanel': 'Toggle Left Panel',
  'menu.view.toggleRightPanel': 'Toggle Right Panel',
  ...
  'statusbar.row.modified': 'Modified',
  'statusbar.row.saved': 'Saved',
  'statusbar.row.modified.title': 'Document has unsaved changes',
  'statusbar.row.saved.title': 'Document matches the last saved version',
