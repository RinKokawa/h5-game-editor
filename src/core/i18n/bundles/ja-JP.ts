...
const jaJP: Bundle = {
  ...
  'menu.view.resetView': 'ビューをリセット',
  'menu.view.toggleFullScreen': 'フルスクリーン切替',
  'menu.view.toggleConsole': 'コンソール切替',
  'menu.view.toggleLeftPanel': '左パネル切替',
  'menu.view.toggleRightPanel': '右パネル切替',
  ...
  'preferences.languageHint': 'エディタのインターフェース言語を選択してください。',
  'preferences.appearance': '外観',
  'preferences.shortcuts': 'キーボードショートカット',
  ...
  'statusbar.row.modified': '未保存',
  'statusbar.row.saved': '保存済み',
  'statusbar.row.modified.title': '未保存の変更があります',
  'statusbar.row.saved.title': '最後に保存した内容と一致しています',
