...
const zhCN: Bundle = {
  ...
  'menu.view.resetView': '重置视图',
  'menu.view.toggleFullScreen': '切换全屏',
  'menu.view.toggleConsole': '切换控制台',
  'menu.view.toggleLeftPanel': '切换左侧栏',
  'menu.view.toggleRightPanel': '切换右侧栏',
  'menu.help.about': '关于',
  'menu.help.docs': '文档',
  'about.close': '关闭',
  ...
  'preferences.languageHint': '选择编辑器界面语言。',
  'preferences.appearance': '外观',
  'preferences.shortcuts': '键盘快捷键',
  ...
  'statusbar.row.modified': '已修改',
  'statusbar.row.saved': '已保存',
  'statusbar.row.modified.title': '文档有未保存的更改',
  'statusbar.row.saved.title': '文档与上次保存版本一致',
